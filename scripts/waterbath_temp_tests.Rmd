...
#Quick conclusions:
chambers tend to heat/cool at nearly half the rate of the water baths(nov 23 exp.), which can mean for longer equilibration times but also means greater temperature stability at a given temperature set point. Overhead lightling did not have a large effect on temperature stability (nov 19 & 23 exps.), tanks were able to maintain temp well, however tank heating/chilling efficiency was very low when operating at low temps (Nov 24th exp.).
