...
It also appears that temperature had the only significant effect (increasing both GPP and ER), and had a larger stimulatory effect on GPP rather than R. There are some potential issues with violations of linear model assumptions--particularly with normality--that need to be addressed.
