...
```{r}
# nutrient effect averaged over season
emmeans(ER_final, pairwise ~ nutrient_trt, cov.keep = "temp_C", type = "response")
...
```{r}
# nutrient effect averaged over season
emmeans(NEP_final, pairwise ~ nutrient_trt, cov.keep = "temp_C", type = "response")
...
tab_model(GPP_contr_sum, ER_contr_sum, NEP_contr_sum, dv.labels = c("GPP", "ER", "NEP"),
  ...
  p.style = "stars", 
  transform = "exp",
  file = "plots/final_paper/Table2_sum_contr.doc")
```
...
gtsave("plots/final_paper/Appendix12_GPP.docx", data = GPP)
...
gtsave("plots/final_paper/Appendix12_ER.docx", data = ER)
...
gtsave("plots/final_paper/Appendix12_NEP.docx", data = NEP)
