...
# updating ER model to remove the y intercept using update()
# this will make the fixed effect estimates easier to interpret by showing all levels of the factor variables in the model summary
ER_new <- update(ER_final, ~ . -1)
summary(ER_new)
```
