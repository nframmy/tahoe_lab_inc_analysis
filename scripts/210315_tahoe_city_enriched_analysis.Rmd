...
## the linear portion of the NEP curve is roughly from minute 95 to minute 170 ##
tc_e_1 <- dat_full %>%
  filter(chamber == "Chamber 1" & delta_T_min >= 95 & delta_T_min <= 170)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 170 ##
tc_e_8 <- dat_full %>%
  filter(chamber == "Chamber 8" & delta_T_min >= 95 & delta_T_min <= 170)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 170 ##
tc_e_12 <- dat_full %>%
  filter(chamber == "Chamber 12" & delta_T_min >= 95 & delta_T_min <= 170)
...
### Tank 2; 7C
#### Chamber 15
##### Did not stir correctly, thus rates are not accurate

#### Chamber 7
```{r}
######################## NEP rate calculations

## the linear portion of the NEP curve is roughly from minute 95 to minute 175 ##
tc_e_7 <- dat_full %>%
  filter(chamber == "Chamber 7" & delta_T_min >= 95 & delta_T_min <= 175)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 175 ##
tc_e_6 <- dat_full %>%
  filter(chamber == "Chamber 6" & delta_T_min >= 95 & delta_T_min <= 175)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 175 ##
tc_e_5 <- dat_full %>%
  filter(chamber == "Chamber 5" & delta_T_min >= 95 & delta_T_min <= 175)
...
## the linear portion of the NEP curve is roughly from minute 97 to minute 172 ##
tc_e_3 <- dat_full %>%
  filter(chamber == "Chamber 3" & delta_T_min >= 97 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 97 to minute 172 ##
tc_e_2 <- dat_full %>%
  filter(chamber == "Chamber 2" & delta_T_min >= 97 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 97 to minute 172 ##
tc_e_4 <- dat_full %>%
  filter(chamber == "Chamber 4" & delta_T_min >= 97 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 97 to minute 172 ##
tc_e_10 <- dat_full %>%
  filter(chamber == "Chamber 10" & delta_T_min >= 97 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 172 ##
tc_e_16 <- dat_full %>%
  filter(chamber == "Chamber 16" & delta_T_min >= 95 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 172 ##
tc_e_11 <- dat_full %>%
  filter(chamber == "Chamber 11" & delta_T_min >= 95 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 172 ##
tc_e_13 <- dat_full %>%
  filter(chamber == "Chamber 13" & delta_T_min >= 95 & delta_T_min <= 172)
...
## the linear portion of the NEP curve is roughly from minute 95 to minute 172 ##
tc_e_14 <- dat_full %>%
  filter(chamber == "Chamber 14" & delta_T_min >= 95 & delta_T_min <= 172)
...
```{r}
# creating dataframe of anoxic flux rates to make barplot
...
# adding temperature treatment column based off of tank column already in data
dat_final <- dat_final %>%
  mutate(treatment = ifelse(tank == "1", "10C", ifelse(tank == "2", "7C", ifelse(tank == "3", "13C", "16C"))))
```

# Normalizing metabolic rates to biomass metrics
```{r}
dat_final <- dat_final %>%
...
# trying to use gather instead of melt to set up using error bars on 3 separate y variables
#gather_metab <- metab_avg %>%
  gather(key = "rate_variable", value = val, sd)
...
# adding in a sd column for each metabolic rate type
#melt_metab <- melt_metab %>%
  #mutate(sd = ifelse(rate_variable == "GPP" & treatment == "7C", 7.999, ifelse(rate_variable == "GPP" & treatment == "10C", 86.443, rate_variable == "GPP" & treatment == "13C", 88.81, ifelse(rate_variable == "GPP" & treatment == "16C", 86.432, ifelse(rate_variable == "NEP" & treatment == "7C", 3.38, ifelse(rate_variable == "NEP" & treatment == "10C", 62.323, ifelse(rate_variable == "NEP" & treatment == "13C", 62.849, ifelse(rate_variable == "NEP" & treatment == "16C", 44.216, ifelse(rate_variable == "ER" & treatment == "7C", 4.623, ifelse(rate_variable == "ER" & treatment == "10C", 24.741, ifelse(rate_variable == "ER" & treatment == "13C", 26.166, 44.55)))))))) )))
...
ggsave("plots/210315_tahoecity_enriched/210315_tahoecity_rate_plot.png", plot = rate_plot, width = 15, height = 7)
```
