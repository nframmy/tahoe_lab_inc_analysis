...
melt_dat <- melt(dat_final, id.vars = c("Location", "Sample_Date", "Sample_Depth_cm",  "Month", "Year", "Depth_m" ), variable.name = "nutrient_variable", value.name = "phosphorus_concentration")
#View(melt_sedwater)

# plotting various rates normalized to AFDW for each temperature treatment
dat_final %>%
  ggplot(aes(treatment, fill = ))
```
