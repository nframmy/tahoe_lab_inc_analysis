...
SA_rate_plot <- SA_melt_metab %>%
  ...
  labs(y = expression(Metabolic~Rate~(mgO[2]~day^{-1}~m^{2})), x = "Temperature Treatment", title = "Tahoe City Enriched Incubation-Surface Area Normalized Metabolism") +
  scale_fill_viridis_d(name = "Rate Variable", labels = c("GPP", "NEP", "ER")) +
