...
## The linear portion of the ER curve has a very small signal, thus I measured ER from the dark period preceding the NEP portion of the incubation (roughly from minute 155 to minute 168) and averaged this with the ER signal post-NEP period. Chambers in this tank did not stir properly from minute 117-150 so I did not include this period in the analysis.
...
# calculate average of the two ER slopes
pnld_a_3_ER_slope_avg <- (pnld_a_3_ER_slope + pnld_a_3_ER_slope2)/2
...
# calculate average of the two ER slopes
pnld_a_7_ER_slope_avg <- (pnld_a_7_ER_slope + pnld_a_7_ER_slope2)/2
...
# calculate average of the two ER slopes
pnld_a_10_ER_slope_avg <- (pnld_a_10_ER_slope + pnld_a_10_ER_slope2)/2
...
# calculate average of the two ER slopes
pnld_a_5_ER_slope_avg <- (pnld_a_5_ER_slope + pnld_a_5_ER_slope2)/2
