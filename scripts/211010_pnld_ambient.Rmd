...
## the linear portion of the NEP curve is roughly from minute 10 to minute 100 ##

pnld_a_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 10 & delta_T_min <= 100)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 100.
pnld_a_4 <- dat_full %>%
  filter(chamber =="4" & delta_T_min >= 100)
...
pnld_a_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 10 & delta_T_min <= 100)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 100).
pnld_a_6 <- dat_full %>%
  filter(chamber =="6" & delta_T_min >= 100)
...
pnld_a_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 10 & delta_T_min <= 100)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 100).
pnld_a_9 <- dat_full %>%
  filter(chamber =="9" & delta_T_min >= 100)
...
pnld_a_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 10 & delta_T_min <= 100)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 100).
pnld_a_15 <- dat_full %>%
  filter(chamber =="15" & delta_T_min >= 100)
...
## the linear portion of the NEP curve is roughly from minute 10 to minute 98 ##

pnld_a_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 10 & delta_T_min <= 98)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 98).
pnld_a_1 <- dat_full %>%
  filter(chamber =="1" & delta_T_min >= 98)
...
pnld_a_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 10 & delta_T_min <= 98)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 98).
pnld_a_2 <- dat_full %>%
  filter(chamber =="2" & delta_T_min >= 98)
...
pnld_a_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 10 & delta_T_min <= 98)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 98).
pnld_a_5 <- dat_full %>%
  filter(chamber =="5" & delta_T_min >= 98)
...
pnld_a_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 10 & delta_T_min <= 98)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 98).
pnld_a_12 <- dat_full %>%
  filter(chamber =="12" & delta_T_min >= 98)
...
## the linear portion of the NEP curve is roughly from minute 10 to minute 101 ##

pnld_a_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 10 & delta_T_min <= 101)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 101).
pnld_a_3 <- dat_full %>%
  filter(chamber =="3" & delta_T_min >= 101)
...
pnld_a_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 10 & delta_T_min <= 101)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 101).
pnld_a_10 <- dat_full %>%
  filter(chamber =="10" & delta_T_min >= 101)
...
pnld_a_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 10 & delta_T_min <= 101)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 101).
pnld_a_11 <- dat_full %>%
  filter(chamber =="11" & delta_T_min >= 101)
...
pnld_a_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 10 & delta_T_min <= 101)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 101).
pnld_a_13 <- dat_full %>%
  filter(chamber =="13" & delta_T_min >= 101)
...
## the linear portion of the NEP curve is roughly from minute 10 to minute 99 ##

pnld_a_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 10 & delta_T_min <= 99)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 99).
pnld_a_7 <- dat_full %>%
  filter(chamber =="7" & delta_T_min >= 99)
...
pnld_a_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 10 & delta_T_min <= 99)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 99).
pnld_a_8 <- dat_full %>%
  filter(chamber =="8" & delta_T_min >= 99)
...
pnld_a_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 10 & delta_T_min <= 99)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 99).
pnld_a_14 <- dat_full %>%
  filter(chamber =="14" & delta_T_min >= 99)
...
pnld_a_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 10 & delta_T_min <= 99)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 99).
pnld_a_16 <- dat_full %>%
  filter(chamber =="16" & delta_T_min >= 99)
...
write_csv(dat_final, "data/211010_pineland_a_e/211010_pnld_ambient_rates.csv")
```