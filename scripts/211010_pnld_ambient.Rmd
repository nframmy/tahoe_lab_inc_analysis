...
## the linear portion of the NEP curve is roughly from minute 10 to minute 93 ##

pnld_a_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 10 & delta_T_min <= 93)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 103.
pnld_a_4 <- dat_full %>%
  filter(chamber =="4" & delta_T_min >= 103)
...
pnld_a_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 10 & delta_T_min <= 93)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 103).
pnld_a_6 <- dat_full %>%
  filter(chamber =="6" & delta_T_min >= 103)
...
pnld_a_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 10 & delta_T_min <= 93)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 103).
pnld_a_9 <- dat_full %>%
  filter(chamber =="9" & delta_T_min >= 103)
...
pnld_a_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 10 & delta_T_min <= 93)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 103).
pnld_a_15 <- dat_full %>%
  filter(chamber =="15" & delta_T_min >= 103)
...
pnld_a_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 10 & delta_T_min <= 93)
...
pnld_a_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 10 & delta_T_min <= 93)
