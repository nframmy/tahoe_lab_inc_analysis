...
tab_model(m0, m1, m2, m3, m5, dv.labels = c("Model0", "Model1", "Model2", "Model3", "Model5"),
  show.ci = FALSE,
  show.aic = T,
  p.style = "stars",
  transform = NULL)
...
# summary table for model comparison
tab_model(m0, m1, m2, m3, dv.labels = c("Model0", "Model1", "Model2", "Model3"),
  show.ci = FALSE,
  show.aic = T,
  p.style = "stars",
  transform = NULL)
...
# summary table for model comparison
tab_model(m0, m1, m2, m3, m4, m5, dv.labels = c("Model0", "Model1", "Model2", "Model3", "Model4", "Model5"),
  show.ci = FALSE,
  show.aic = T,
  p.style = "stars",
  transform = NULL)
