...
# changing exp_ID from a fixed effect to a random effect in the models and also nesting rock_ID within exp_ID
...
emmip(m9, nutrients ~ temp_C, cov.reduce = F, CIs = T) +
  geom_point(aes(x = temp_C, y = log(GPP_mgO2_d_gAFDW_2), color = interaction(temp_C, nutrients)), data = dat_lme)

# why is emmip treating the temp_C variable as a factor instead of numeric??
...
tab_model(m1, m2, m3, m4, m6, m7, dv.labels = c("Model1", "Model2", "Model3", "Model4", "Model6", "Model7"),
  show.ci = FALSE, 
  show.p = FALSE, 
  transform = NULL)
```
...
tab_model(m1, m2, m3, m4, m5, m6, m7, m8, m9, dv.labels = c("Model1", "Model2", "Model3", "Model4", "Model5", "Model6", "Model7", "Model8", "Model9"),
  show.ci = FALSE, 
  show.p = FALSE, 
  transform = NULL)
```
