...
# Creating new delta_T_min column to reflect new datetimes generated for Tank 4 in other script
dat <- dat %>%
...
# checking slopes of 2 models that were averaged to get ER rate
pnld_e_5_ER_mod$coefficients[2]
pnld_e_5_ER_mod2$coefficients[2]
```
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 18 & delta_T_min <= 112)
...
## The ER curve preceding the NEP portion of the experiment is very messy, thus I excluded this rate from the analysis and just used the post NEP ER rate.
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_9_ER_slope_avg <- pnld_e_9_ER_slope2


## Now converting this rate from mg O2 per minute to per day by multiplying this rate by 1440 minutes per day. ##
pnld_e_9_ER <- pnld_e_9_ER_slope_avg * 1440
pnld_e_9_ER
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min <= 19)
...
# R^2 value below 0.9, thus I excluded this model from the analysis. The slope was almost identical to the post_NEP model slope and both ER values seemed accurate.

## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_10_ER_slope_avg <-  pnld_e_10_ER_slope2


## Now converting this rate from mg O2 per minute to per day by multiplying this rate by 1440 minutes per day. ##
pnld_e_10_ER <- pnld_e_10_ER_slope_avg * 1440
pnld_e_10_ER
...
##### The R^2 value of ER model 1 is below 0.9, thus I excluded this model from the analysis. The slope was almost identical to the second ER model slope and both ER values seemed accurate.
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_16_ER_slope_avg <- pnld_e_16_ER_slope2


## Now converting this rate from mg O2 per minute to per day by multiplying this rate by 1440 minutes per day. ##
pnld_e_16_ER <- pnld_e_16_ER_slope_avg * 1440
pnld_e_16_ER
...
##### The R^2 of ER model 1 is below 0.9, thus I exlude this model from the analysis. Despite this, the slope from this model is a very close match to the slope from the following model of ER.
...
# calculate average of the two ER slopes
pnld_e_6_ER_slope_avg <- pnld_e_6_ER_slope2
...
##### The R^2 of ER model 1 is below 0.9, thus I exlude this model from the analysis.
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_7_ER_slope_avg <- pnld_e_7_ER_slope2
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_13_ER_slope_avg <- pnld_e_13_ER_slope2
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 111)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 111)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 18 & delta_T_min <= 112)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 111)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 18 & delta_T_min <= 112)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 111).
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 111)
...
# calculate average of the two ER slopes
pnld_e_15_ER_slope_avg <- pnld_e_15_ER_slope2
...
pnld_e_15_plot <- dat_full %>%
  ...
  geom_abline(aes(intercept = pnld_e_15_ER_mod2$coefficients[1], slope = pnld_e_15_ER_mod2$coefficients[2])) +
  theme_classic()
pnld_e_15_plot
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 17 & delta_T_min <= 125)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 124).
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 124)
...
pnld_e_2_plot <- dat_full %>%
  ...
  geom_abline(aes(intercept = pnld_e_2_ER_mod2$coefficients[1], slope = pnld_e_2_ER_mod2$coefficients[2])) +
  theme_classic()
pnld_e_2_plot
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 17 & delta_T_min <= 125)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 124).
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 124)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 17 & delta_T_min <= 125)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min <= 19)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve starting at minute 124).
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 124)
...
# calculate average of the two ER slopes
pnld_e_12_ER_slope_avg <- pnld_e_12_ER_slope2
...
write_csv(dat_final_e, "data/210613_pineland_a_e/210613_pnld_enriched_rates.csv")
```
