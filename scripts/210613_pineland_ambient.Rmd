...
```{r, include = FALSE}
dat <- read_csv("data/210613_pineland_a_e/210613_pineland_ambient_O2.csv", skip = 1)
head(dat)
#View(dat)
...
# looks like chamber 9 had errors associated with all the DO msmts and will be removed from the analysis
dat %>%
  filter(tank_channel == "Tank 1_3")
...
dat_full <- dat_full %>%
  ...
  slice(1:45243) #removing last row since channel 9 was not in DO dataset due to errors and got added on at the end in the data joining in line 93
#View(dat_full)
```
...
ggsave("plots/210613_pineland_ambient_enriched/210613_pineland_ambient_DO_conc_plot.png", plot = DO_conc_plot, width = 10, height = 7)
...
ggsave("plots/210613_pineland_ambient_enriched/210613_pineland_ambient_temp_plot.png", plot = temp_plot, width = 10, height = 7)
...
ggsave("plots/210613_pineland_ambient_enriched/210613_pineland_ambient_DO_mass_plot.png", plot = DO_mass_plot, width = 10, height = 7)
...
htmlwidgets::saveWidget(as_widget(p), "plots/210613_pineland_ambient_enriched/210613_pineland_ambient_DO_mass_plot.html")
...
## the linear portion of the NEP curve is roughly from minute 8 to minute 117 ##

pnld_a_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_3 <- dat_full %>%
  filter(chamber =="3" & delta_T_min >= 116)
...
pnld_a_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_6 <- dat_full %>%
  filter(chamber =="6" & delta_T_min >= 116)
...
pnld_a_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_12 <- dat_full %>%
  filter(chamber =="12" & delta_T_min >= 116)
...
pnld_a_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_16 <- dat_full %>%
  filter(chamber =="16" & delta_T_min >= 116)
...
pnld_a_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_2 <- dat_full %>%
  filter(chamber =="2" & delta_T_min >= 116)
...
pnld_a_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_4 <- dat_full %>%
  filter(chamber =="4" & delta_T_min >= 116)
...
#### Chamber 9
##### No data for this chamber due to errors codes in presens DO data associated with this chamber. This was due to a damaged fiber optic cable.
...
pnld_a_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_13 <- dat_full %>%
  filter(chamber =="13" & delta_T_min >= 116)
...
pnld_a_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_5 <- dat_full %>%
  filter(chamber =="5" & delta_T_min >= 116)
...
pnld_a_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_7 <- dat_full %>%
  filter(chamber =="7" & delta_T_min >= 116)
...
pnld_a_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_11 <- dat_full %>%
  filter(chamber =="11" & delta_T_min >= 116)
...
pnld_a_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_14 <- dat_full %>%
  filter(chamber =="14" & delta_T_min >= 116)
...
pnld_a_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_1 <- dat_full %>%
  filter(chamber =="1" & delta_T_min >= 116)
...
pnld_a_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_8 <- dat_full %>%
  filter(chamber =="8" & delta_T_min >= 116)
...
pnld_a_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_10 <- dat_full %>%
  filter(chamber =="10" & delta_T_min >= 116)
...
pnld_a_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 8 & delta_T_min <= 117)
...
## now measuring ER from the period after the NEP portion of the incubation (oxygen curve stabilizes past minute 116).
pnld_a_15 <- dat_full %>%
  filter(chamber =="15" & delta_T_min >= 116)
...
pnld_a_rates <- data.frame(
  "NEP_mg_d" = c(pnld_a_1_NEP, pnld_a_2_NEP, pnld_a_3_NEP, pnld_a_4_NEP, pnld_a_5_NEP, pnld_a_6_NEP, pnld_a_7_NEP, pnld_a_8_NEP, "NA", pnld_a_10_NEP, pnld_a_11_NEP, pnld_a_12_NEP, pnld_a_13_NEP, pnld_a_14_NEP, pnld_a_15_NEP, pnld_a_16_NEP),
  "ER_mg_d" = c(pnld_a_1_ER, pnld_a_2_ER, pnld_a_3_ER, pnld_a_4_ER, pnld_a_5_ER, pnld_a_6_ER, pnld_a_7_ER, pnld_a_8_ER, "NA", pnld_a_10_ER, pnld_a_11_ER, pnld_a_12_ER, pnld_a_13_ER, pnld_a_14_ER, pnld_a_15_ER,  pnld_a_16_ER),
...
write_csv(dat_final_e, "data/210613_pineland_a_e/210613_pnld_ambient_rates.csv")
```