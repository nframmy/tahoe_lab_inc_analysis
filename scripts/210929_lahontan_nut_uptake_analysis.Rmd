...
AFDW <- main %>%
  ...
  filter(date_chamber != "2021-11-28_F_15" & date_chamber != "2021-11-28_F_2") %>% # removing outlier datapoints for november rates
...
# calculating average nutrient uptake rate for season for in-situ temps
```{r}
control_uptake <- main %>%
