...
ggsave("plots/final_paper/FigureS2.jpg", plot = background_nut_uptake, height = 3, width = 7, dpi = 300)
...
metab_dat <- metab_dat %>%
  ...
  dplyr::select(chamber_ID, total_AFDW_g, rock_SA_m2, GPP_mgO2_d_gAFDW_2, ER_mgO2_d_gAFDW_2, NEP_mgO2_d_gAFDW_2, GPP_mg_d, ER_mg_d, NEP_mg_d) # selecting only the columns I need to declutter dataframe a bit
...
ggsave("plots/final_paper/FigureS4_1.jpg", plot = AFDW, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureS3.jpg", plot = uptake_v_amb_nuts, height = 4, width = 18, dpi = 300)
...
ggsave("plots/final_paper/FigureS4_2.jpg", plot = AFDW_molar, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureS5.jpg", plot = mol_ratio_plot, width = 7, height = 4, dpi = 300)
