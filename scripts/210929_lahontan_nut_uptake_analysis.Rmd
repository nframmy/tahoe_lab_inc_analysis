...
amb_plot <- amb %>%
  ...
  geom_point() +
  geom_line() +
  scale_linetype_discrete(name = "Nutrient", labels = expression(DP, SRP, NH[4]-N, NO[3]-N)) +
...
ggsave("plots/final_paper/FigureS3.jpg", plot = amb_plot, height = 4, width = 7, dpi = 300)
```
...
ggsave("plots/final_paper/FigureS5_1.jpg", plot = AFDW, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureS4.jpg", plot = uptake_v_amb_nuts, height = 4, width = 18, dpi = 300)
...
ggsave("plots/final_paper/FigureS5_2.jpg", plot = AFDW_molar, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureS6.jpg", plot = mol_ratio_plot, width = 7, height = 4, dpi = 300)
