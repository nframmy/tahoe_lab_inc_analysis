...
ggsave("plots/final_paper/Appendix6.jpg", plot = amb_plot, height = 4, width = 7, dpi = 300)
```
...
ggsave("plots/final_paper/Appendix4.jpg", plot = background_nut_uptake, height = 3, width = 7, dpi = 300)
```
...
ggsave("plots/final_paper/Appendix8.jpg", plot = AFDW, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureG1.jpg", plot = uptake_v_amb_nuts, height = 4, width = 18, dpi = 300)
...
ggsave("plots/final_paper/FigureH2.jpg", plot = AFDW_molar, width = 7, height = 4, dpi = 300)
...
ggsave("plots/final_paper/FigureI1.jpg", plot = mol_ratio_plot, width = 7, height = 4, dpi = 300)
