---
title: "211010 Pineland Enriched"
...
```{r, include = FALSE}
dat <- read_csv("data/211010_pineland_a_e/211010_pineland_enriched_O2.csv", skip = 1)
#head(dat)
#View(dat)
...
dat_2 <- dat %>%
  ...
  mutate(
    ...
    tank_channel == "Tank 1_2"  ~ "3",
    tank_channel == "Tank 1_3" ~ "7",
    tank_channel == "Tank 1_4" ~ "8",
    tank_channel == "Tank 2_1" ~ "5",
    tank_channel == "Tank 2_2" ~ "10",
    tank_channel == "Tank 2_3" ~ "12",
    tank_channel == "Tank 2_4" ~ "15",
    tank_channel == "Tank 3_1" ~ "2",
    tank_channel == "Tank 3_2" ~ "11",
...
ggsave("plots/211010_pineland_ambient_enriched/211010_pineland_enriched_DO_conc_plot.png", plot = DO_conc_plot, width = 10, height = 11)
...
ggsave("plots/211010_pineland_ambient_enriched/211010_pineland_enriched_temp_plot.png", plot = temp_plot, width = 10, height = 11)
...
ggsave("plots/211010_pineland_ambient_enriched/211010_pineland_enriched_DO_mass_plot.png", plot = DO_mass_plot, width = 10, height = 11)
...
htmlwidgets::saveWidget(as_widget(p), "plots/211010_pineland_ambient_enriched/211010_pineland_enriched_DO_mass_plot.html")
...
## the linear portion of the NEP curve is roughly from minute 37 to minute 123 ##

pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 37 & delta_T_min <= 123)
...
pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 123)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 37 & delta_T_min <= 123)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 123)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 37 & delta_T_min <= 123)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 123)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 37 & delta_T_min <= 123)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 123)
...
## the linear portion of the NEP curve is roughly from minute 37 to minute 119 ##

pnld_e_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 119)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 119)
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 119)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 119)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 119)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 119)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 119)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 37 & delta_T_min <= 119)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 119)
...
## the linear portion of the NEP curve is roughly from minute 37 to minute 118 ##

pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 37 & delta_T_min <= 118)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 118)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 37 & delta_T_min <= 118)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 118)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 37 & delta_T_min <= 118)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 118)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 37 & delta_T_min <= 118)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 118)
...
write_csv(dat_final, "data/211010_pineland_a_e/211010_pnld_enriched_rates.csv")
```