...
m1 <- lmer(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients + (1 + log(temp_C)|season), data = dat_clean)
display(m1)
summary (m1)
...
m2 <- lmer(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients + (1|season), data = dat_clean)
display(m2)
summary(m2)

m3 <- lmer(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients + (1 + nutrients|season), data = dat_clean)

m4 <- lmer(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients + (1 + nutrients|season) + (1 + log(temp_C)|season), data = dat_clean)

m5 <- lm(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients, data = dat_clean)

m6 <- lm(log(GPP_mgO2_d_gAFDW) ~ log(temp_C), data = dat_clean)

m7 <- lm(log(GPP_mgO2_d_gAFDW) ~ nutrients, data = dat_clean)

m8 <- lm(log(GPP_mgO2_d_gAFDW) ~ log(temp_C)*nutrients*season, data = dat_clean)
summary(m8)
